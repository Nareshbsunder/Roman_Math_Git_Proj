...
/* ./.libs/lt-implementation_test.c - temporary wrapper executable for .libs/implementation_test
   Generated by libtool (GNU libtool) 2.4.6

   The implementation_test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "implementation_test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# implementation_test - temporary wrapper script for .libs/implementation_test\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The implementation_test program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"implementation_test:implementation_test:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"implementation_test:implementation_test:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"implementation_test:implementation_test:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='implementation_test'\n", f);
