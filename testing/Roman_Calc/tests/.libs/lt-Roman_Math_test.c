...
/* ./.libs/lt-Roman_Math_test.c - temporary wrapper executable for .libs/Roman_Math_test
   Generated by libtool (GNU libtool) 2.4.6

   The Roman_Math_test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "Roman_Math_test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# Roman_Math_test - temporary wrapper script for .libs/Roman_Math_test\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The Roman_Math_test program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"Roman_Math_test:Roman_Math_test:$LINENO: libtool wrapper (GNU libtool", f);
  fputs (") 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"Roman_Math_test:Roman_Math_test:$LINENO: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"Roman_Math_test:Roman_Math_test:$LINENO: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
